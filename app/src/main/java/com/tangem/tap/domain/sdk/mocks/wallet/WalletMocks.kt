...
object WalletMocks : Mocks {
    ...
    private val cardDto = CardDTO(
        ...
        isPasscodeSet = false,
        supportedCurves = listOf(EllipticCurve.Secp256k1, EllipticCurve.Ed25519, EllipticCurve.Secp256r1, EllipticCurve.Bls12381G2, EllipticCurve.Bls12381G2Aug, EllipticCurve.Bls12381G2Pop, EllipticCurve.Bip0340),
        wallets = listOf(
            CardDTO.Wallet(
