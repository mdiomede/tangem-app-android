...
internal object SettingsDomainModule {
    ...
    @Provides
    @ViewModelScoped
    fun provideSetWalletsScrollPreviewIsShown(settingsRepository: SettingsRepository): SetWalletsScrollPreviewIsShown {
        return SetWalletsScrollPreviewIsShown(settingsRepository = settingsRepository)
    }
