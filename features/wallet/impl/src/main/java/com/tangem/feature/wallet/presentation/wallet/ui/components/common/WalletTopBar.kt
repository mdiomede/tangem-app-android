...
internal fun WalletTopBar(config: WalletTopBarConfig) {
    TopAppBar(
        ...
        actions = {
            IconButton(onClick = config.onDetailsClick, modifier = Modifier.testTag(TestTags.MAIN_SCREEN_MORE_BUTTON)) {
        ...
        modifier = Modifier.testTag(TestTags.MAIN_SCREEN_TOP_BAR)
    )
}
