...
import com.tangem.domain.settings.SetWalletsScrollPreviewIsShown
...
import com.tangem.feature.wallet.presentation.wallet.viewmodels.utils.unwrap
...
internal class WalletClickIntentsV2 @Inject constructor(
    ...
    private val setWalletsScrollPreviewIsShown: SetWalletsScrollPreviewIsShown,
    ...
    fun onWalletChange(index: Int) {
        viewModelScope.launch(dispatchers.main) {
            launch(dispatchers.main) { setWalletsScrollPreviewIsShown() }
